...
public class UniversityServiceImpl implements UniversityService {
	...
	public UniversityDetailVO selectUniversityDetail(int univId) {
	    ...
	    if (universityDetail != null) {
	        ...
	        log.info("selectUniversityDetail 완료 - univName: {}, deptCount: {}", 
	                universityDetail.getUnivName(), universityDetail.getTotalDeptCount());
	                
	        // 학과 구분별 통계는 별도로 필요하면 추가
	        // List<UniversityDetailVO.DeptStats> deptStatsList = this.universityMapper.selectUniversityDeptStats(univId);
	        // universityDetail.setDeptStatsList(deptStatsList);
	    } else {
