...
public class UnivDeptCompareVO {
    ...
    public String getSatisfactionGrade() {
        if (satisfactionAvg == null) return "정보없음";
        
        if (satisfactionAvg >= 4.5) return "A+";
        else if (satisfactionAvg >= 4.0) return "A";
        else if (satisfactionAvg >= 3.5) return "B+";
        else if (satisfactionAvg >= 3.0) return "B";
        else if (satisfactionAvg >= 2.5) return "C+";
        else if (satisfactionAvg >= 2.0) return "C";
        else return "D";
    }
    ...
    public String getAvgTuitionFormatted() {
        return avgTuition != null ? 
            String.format("%,d만원", avgTuition / 10000) : "정보없음";
    }
    ...
    public String getAvgScholarFormatted() {
        return avgScholar != null ? 
            String.format("%,d만원", avgScholar / 10000) : "정보없음";
    }
    ...
    public String getSatisfactionFormatted() {
        return satisfactionAvg != null ? 
            String.format("%.1f점 (%s)", satisfactionAvg, getSatisfactionGrade()) : "정보없음";
    }
}