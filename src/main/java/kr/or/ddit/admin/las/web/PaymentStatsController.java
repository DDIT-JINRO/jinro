...
public class PaymentStatsController {
    ...
    // 총 구독자 수와 신규 구독자 수 통합 API
    @GetMapping("/subscriber-summary")
    public Map<String, Object> subscriberSummary() {
        return paymentStatsService.getSubscriberSummary();
    }
    ...
    public List<Map<String, Object>> newUserRevenueRate(@RequestParam Map<String, Object> params) {
        return paymentStatsService.selectNewUserRevenueRate(params);
    }

    // 총 구독 결제 대비하여 신규 구독 결제 비율 - 대시보드용
    @GetMapping("/newRevenue-rateStats")
    public List<Map<String, Object>> newRevenueRateStats(@RequestParam Map<String, Object> params) {
        return paymentStatsService.selectNewRevenueRateStats(params);
    }
