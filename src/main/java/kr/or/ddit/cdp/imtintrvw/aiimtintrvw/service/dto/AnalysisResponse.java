...
public class AnalysisResponse {
    ...
    public static AnalysisResponse createDefaultResponse(String sessionId, String errorMessage) {
        ...
        detailed.setAudio(new DetailedAnalysis.AudioAnalysis(70, 70, 70, 
            "음성 분석 중 오류가 발생했습니다: " + errorMessage));
        detailed.setVideo(new DetailedAnalysis.VideoAnalysis(70, 70, 70, 
            "영상 분석 중 오류가 발생했습니다: " + errorMessage));
        detailed.setText(new DetailedAnalysis.TextAnalysis(70, 70, 70, 
            "텍스트 분석 중 오류가 발생했습니다: " + errorMessage));
        response.setDetailed(detailed);
        
        // 기본 요약
        response.setSummary(new AnalysisSummary(
            List.of("면접 참여에 감사드립니다", "기본적인 준비가 되어있습니다"),
            List.of("기술적 문제로 정확한 분석이 어려웠습니다", "다시 시도해보시기 바랍니다"),
            "기술적 문제가 발생했지만, 지속적인 연습으로 실력을 향상시켜보세요."
        ));
