...
public class EmploymentAdvertisementController {
	...
	public String emplymentAdvertisementList(
		...
		log.info("hireVOList"+ hireVOList);
		...
		ArticlePage<HireVO> articlePage =
				new ArticlePage<HireVO>(total, hireVO.getCurrentPage(), hireVO.getSize(), hireVOList, hireVO.getKeyword());
