...
<div>
	<div class="public-wrapper">
		...
		<div class="tab-container" id="tabs">
		    ...
		    <div class="tab active"><a href="/mpg/mif/pswdchg/selectPasswordChangeView.do">비밀번호 변경</a></div>
		    <div class="tab"><a href="/mpg/mif/whdwl/selectWithdrawalView.do">회원 탈퇴</a></div>
  		</div>
		<!-- 여기부터 작성해 주시면 됩니다 -->
