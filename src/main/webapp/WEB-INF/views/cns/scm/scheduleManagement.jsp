...
<div class="template-container">
    ...
    <div class="counsel-info-summary">
        <div class="info-item">
            <span class="info-label">상담 분야</span>
            <span class="info-value" id="counselCategory"></span>
        </div>
        <div class="info-item">
            <span class="info-label">상담 방법</span>
            <span class="info-value" id="counselMethod"></span>
        </div>
        <div class="info-item">
            <span class="info-label">상담 예약일</span>
            <span class="info-value" id="counselReqDate"></span>
        </div>
        <div class="info-item">
            <span class="info-label">상담 예약시간</span>
            <span class="info-value" id="counselReqTime"></span>
        </div>
        <div class="info-item">
            <span class="info-label">상담 상태</span>
            <span class="info-value" id="counselStatus"></span>
        </div>
        <div class="info-item">
            <span class="info-label">예약 상태</span>
            <select id="counselStatusSelect" class="info-value">
    ...
    <div class="counsel-detail-content">
        <div class="counsel-motivation">
            ...
            <textarea class="counsel-textarea" id="counselDescription" placeholder="상담 신청 동기 내용" readonly></textarea>
        </div>
        <div class="personal-info">
            <h4 class="section-title">인적 사항</h4>
            <div class="info-item">
                <span class="info-label">이름:</span>
                <span class="info-value" id="memName"></span>
            </div>
            <div class="info-item">
                <span class="info-label">나이:</span>
                <span class="info-value" id="memAge"></span>
            </div>
            <div class="info-item">
                <span class="info-label">이메일:</span>
                <span class="info-value" id="memEmail"></span>
            </div>
            <div class="info-item">
                <span class="info-label">연락처:</span>
                <span class="info-value" id="memPhoneNumber"></span>
            </div>
        </div>
        <div class="button-group">
            <button class="btn btn-start-counsel">상담 시작</button>
...
<script type="text/javascript" src="/js/include/cns/scm/scheduleManagement.js"></script>