...
<!--   		</div> -->
		<!-- 여기부터 작성해 주시면 됩니다 -->
  		<div class="public-wrapper-main">
  			진로진학 게시판 목록 페이지
  			<br/>
  			<a href="/comm/path/pathDetail.do?boardId=1">진로진학 1번 게시글</a>
  			<br/>
  			<a href="/comm/path/pathDetail.do?boardId=2">진로진학 2번 게시글</a>
  			<br/>
  			<a href="/comm/path/pathDetail.do?boardId=3">진로진학 3번 게시글</a>
  			<br/><br/><br/><br/>
  			<a href="/comm/path/pathInsert.do">진로진학 게시글 작성</a>
  		</div>
	</div>
</div>
