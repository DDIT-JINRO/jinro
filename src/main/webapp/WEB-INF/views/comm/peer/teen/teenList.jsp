...
<div>
	<div class="public-wrapper">
		...
		<div class="tab-container" id="tabs">
		    <div class="tab active"><a href="/comm/peer/teen/teenList.do">청소년 게시판</a></div>
		    <div class="tab"><a href="/comm/peer/youth/youthList.do">청년 게시판</a></div>
  		</div>
		<!-- 여기부터 작성해 주시면 됩니다 -->
  		<div class="public-wrapper-main">
  			청소년 게시판 목록 페이지
  			<br/>
  			<a href="/comm/peer/teen/teenDetail.do?boardId=1">청소년 1번 게시글</a>
  			<br/>
  			<a href="/comm/peer/teen/teenDetail.do?boardId=2">청소년 2번 게시글</a>
  			<br/>
