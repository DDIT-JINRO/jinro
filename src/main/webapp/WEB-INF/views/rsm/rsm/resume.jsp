...
<section class="channel">
	...
	<div class="channel-sub-sections">
		<div class="channel-sub-section-itemIn"><a href="/resume">이력서</a></div>
...
<div>
	<div class="public-wrapper">
		...
		<div class="tab-container" id="tabs">
		    <div class="tab active"><a href="/resume">이력서</a></div>
		    <div class="tab"><a href="">이력서 템플릿 게시판</a></div>
  		</div>
		<!-- 여기부터 작성해 주시면 됩니다 -->
  		<div class="public-wrapper-main">
  			이력서 페이지
  			<a href="/resume/resumedetail">이력서 디테일</a>
  			</br></br></br></br>
  			</br></br></br></br>
  			</br></br></br></br>
  			</br></br></br></br>
