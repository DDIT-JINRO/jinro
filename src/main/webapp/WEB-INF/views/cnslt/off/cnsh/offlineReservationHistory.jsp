...
<section class="channel">
	...
	<div class="channel-sub-sections">
		<!-- 중분류 -->
		<div class="channel-sub-section-itemIn"><a href="/cnslt/off/crsv/offlineReservation.do">오프라인 상담</a></div>
...
<div>
	<div class="public-wrapper">
		...
		<div class="tab-container" id="tabs">
		    <a class="tab " href="/cnslt/off/crsv/offlineReservation.do">상담 예약</a>
		    <a class="tab active" href="/cnslt/cnsh/off/offlineReservationHistory.do">상담 내역</a>
  		</div>
		<!-- 여기부터 작성해 주시면 됩니다 -->
