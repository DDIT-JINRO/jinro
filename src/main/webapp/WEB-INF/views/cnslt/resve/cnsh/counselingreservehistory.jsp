						...
						<div class="search-filter__accordion-panel" id="search-filter-panel">
							<div class="search-filter__accordion-content">
								<div class="search-filter__group">
									...
									<div class="search-filter__options">
										<label class="search-filter__option">
											<input type="radio" name="counselStatus" value="" ${empty param.counselStatus ? 'checked' : '' }>
											<span>전체</span>
										</label>
								...
								<div class="search-filter__group">
									...
									<div class="search-filter__options">
										<label class="search-filter__option">
											<input type="radio" name="counselCategory" value="" ${empty param.counselCategory ? 'checked' : '' }>
											<span>전체</span>
										</label>
								...
								<div class="search-filter__group">
									...
									<div class="search-filter__options">
										<label class="search-filter__option">
											<input type="radio" name="counselMethod" value="" ${empty param.counselMethod ? 'checked' : '' }>
											<span>전체</span>
										</label>
