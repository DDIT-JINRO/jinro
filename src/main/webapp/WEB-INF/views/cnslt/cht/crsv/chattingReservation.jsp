...
<section class="channel">
	...
	<div class="channel-sub-sections">
		...
		<div class="channel-sub-section-itemIn"><a href="/cnslt/cht/crsv/chattingReservation.do">채팅상담</a></div>
...
<div>
	<div class="public-wrapper">
		...
		<div class="tab-container" id="tabs">
		    <a class="tab active" href="/cnslt/cht/crsv/chattingReservation.do">상담 예약</a>
		    <a class="tab" href="/cnslt/cht/cnsh/chattingReservationHistory.do">상담 내역</a>
  		</div>
		<!-- 여기부터 작성해 주시면 됩니다 -->
