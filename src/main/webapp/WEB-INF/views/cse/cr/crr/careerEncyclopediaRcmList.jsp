...
<div>
	<div class="public-wrapper">
		...
		<div class="tab-container" id="tabs">
		    <div class="tab"><a href="/career/cse/cr/crl/selectCareerList.do">직업 목록</a></div>
		    <div class="tab active"><a href="/career/cse/cr/crr/selectCareerRcmList.do">추천 직업</a></div>
  		</div>
		<!-- 여기부터 작성해 주시면 됩니다 -->
  		<div class="public-wrapper-main">
  			이곳은 목록 입니다.
  			<a href="selectCareerRcmDetail.do">상세 화면 가기</a>
  			</br></br></br></br>
  			</br></br></br></br>
  			</br></br></br></br>
  			</br></br></br></br>
