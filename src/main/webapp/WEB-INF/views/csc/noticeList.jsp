...
<div>
	<div class="public-wrapper">
		...
		<div class="tab-container" id="tabs">
		    <div class="tab active"><a href="/noticeList"  style="text-decoration: none; color: inherit;">공지사항</a></div>
		    <div class="tab "><a href="/FAQList"  style="text-decoration: none; color: inherit;">FAQ</a></div>
		...
		<!-- 여기부터 작성해 주시면 됩니다 -->
  		<div class="public-wrapper-main">
  			...
  			<a href="/noticeDetail">공지사항 Detail</a>
  		</div>
	</div>
</div>
