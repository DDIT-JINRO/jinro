...
<h2 style="color: gray; font-size: 18px; margin: 0; line-height: 75px;">결제/프리미엄
	서비스 통계</h2>
	...
	<div class="left-column">
		...
		<div class="cards-row flex gap" style="margin-bottom: 20px;">
			...
			<div class="template-panel public-countCard back-color-green">
				...
				<div class="public-span-space">
					<span id="todaySubscribersRate"
						class="public-span-increase color-white">+0%</span>
		...
		<div class="template-panel large-panel">
			...
			<div class="btn-group flex gap5 revenueChart">
				<input type="hidden" id="revenueChartStartDay" /> <input
					type="hidden" id="revenueChartEndDay" />
				<button class="public-toggle-button" id="revenueChartReset">전체</button>
				<select class="public-toggle-select" name="revenueChartDay"
					id="revenueChartDay">
				...
				</select> <select class="public-toggle-select" name="revenueChartAgeGroup"
					id="revenueChartAgeGroup">
	...
	<div class="right-column">
		...
		<div class="template-panel panel-right">
			...
			<div class="btn-group flex gap5 subscriberChart">
				<input type="hidden" id="subscriberChartStartDay" /> <input
					type="hidden" id="subscriberChartEndDay" />
				<button class="public-toggle-button" id="subscriberChartReset">전체</button>
				<select class="public-toggle-select" name="subscriberChartDay"
					...
					<option value="male">남자</option>
					<option value="female">여자</option>
				</select> <select class="public-toggle-select" name="subscriberChartAgeGroup"
					id="subscriberChartAgeGroup">
					<option value="">연령전체</option>
					<option value="teen">청소년</option>
					<option value="youth">청년</option>
				</select>
...
<div class="flex gap" style="margin-bottom: 20px;">
	<div class="template-panel productPanel">
		...
		<div class="btn-group flex gap5 productChartBtnGroup">
			<input type="hidden" id="productChartStartDay" /> <input
				type="hidden" id="productChartEndDay" />
			<button class="public-toggle-button" id="productChartReset">전체</button>
			<select class="public-toggle-select" name="productChartDay"
				id="productChartDay">
				<option value="daily">일별</option>
				<option value="monthly">월별</option>
				<option value="selectDays">기간선택</option>
				...
				<option value="male">남자</option>
				<option value="female">여자</option>
			</select> <select class="public-toggle-select" name="productChartAgeGroup"
				id="productChartAgeGroup">
				<option value="">연령전체</option>
				<option value="teen">청소년</option>
				<option value="youth">청년</option>
			</select>
	...
	<div class="template-panel aiServiceSpace">
		...
		<div class="btn-group flex gap5 aiServiceChart">
			<input type="hidden" id="aiServiceChartStartDay" /> <input
				type="hidden" id="aiServiceChartEndDay" />
			<button class="public-toggle-button" id="aiServiceChartReset">전체</button>
			<select class="public-toggle-select" name="aiServiceChartDay"
				...
				<option value="male">남자</option>
				<option value="female">여자</option>
			</select> <select class="public-toggle-select" name="aiServiceChartAgeGroup"
				id="aiServiceChartAgeGroup">
				<option value="">연령전체</option>
				<option value="teen">청소년</option>
				<option value="youth">청년</option>
			</select>
			<!-- 새로 추가되는 서비스 유형 선택 셀렉트 -->
			<select class="public-toggle-select" name="aiServiceChartType"
				id="aiServiceChartType">
