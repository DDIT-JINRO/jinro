								...
								<div class="com-filter-options">
									<c:forEach var="cType" items="${contestTypeList}">
										<label class="com-filter-item">
											<input type="checkbox" name="contestTypeFilter" value="${cType.ccId}" data-label="모집 분야" data-name="${cType.ccName}" <c:if test="${fn:contains(checkedFilters.contestTypeFilter, cType.ccId)}">checked</c:if> />
