...
<div>
	<div class="public-wrapper">
		...
		<div class="tab-container" id="tabs">
			<a class="tab active" href="/prg/act/vol/volList.do">봉사활동</a> <a
				class="tab" href="/prg/act/cr/crList.do">직업체험</a> <a class="tab"
			...
			<div class="list-container">
				<c:if test="${not empty articlePage.content}">
					<c:forEach var="contest" items="${articlePage.content}">
						<a href="/prg/act/vol/volDetail.do?volId=${contest.contestId}"
							class="contest-card">
...
<script src="/js/prg/act/vol/volList.js">
