	...
	<div class="public-wrapper">
		...
		<div class="public-wrapper-main">
				...
				<c:forEach var="data" items="${articlePage.content}" varStatus="status">
					<div class="accordion-item">
						<div class="accordion-header">
							...
							<div class="hire-info-item" style="flex: 0.8;">
			...
			<div class="card-footer clearfix">
				<ul class="pagination">
					<li>
						<a href="${articlePage.url}?currentPage=${articlePage.startPage - 5 > 0 ? articlePage.startPage - 5 : 1}&keyword=${param.keyword}&status=${param.status}&region=${param.region}" class="${articlePage.startPage < 6 ? 'disabled' : ''}"> ← Previous </a>
					</li>

					<c:forEach var="pNo" begin="${articlePage.startPage}" end="${articlePage.endPage}">
						<li>
							<a href="${articlePage.url}?currentPage=${pNo}&keyword=${param.keyword}&status=${param.status}&region=${param.region}" class="${pNo == articlePage.currentPage ? 'active' : ''}"> ${pNo} </a>
						</li>
					</c:forEach>

					<li>
						<a href="${articlePage.url}?currentPage=${articlePage.endPage + 1 <= articlePage.totalPages ? articlePage.endPage + 1 : articlePage.totalPages}&keyword=${param.keyword}&status=${param.status}&region=${param.region}" class="${articlePage.endPage >= articlePage.totalPages ? 'disabled' : ''}"> Next → </a>
					</li>
				</ul>
			</div>
