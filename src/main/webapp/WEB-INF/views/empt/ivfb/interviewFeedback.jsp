			                ...
			                <div class="card-body">
			                    <div class="detail-grid">
			                        ...
			                        <div class="detail-item">
			                            ...
			                            <div class="detail-value"><fmt:formatDate value="${content.irInterviewAt}" pattern="yyyy. MM. dd"/></div>
			                        </div>
			                        <div class="detail-item">
			                            <div class="detail-label">작성일</div>
			                            <div class="detail-value"><fmt:formatDate value="${content.irCreatedAt}" pattern="yyyy. MM. dd HH:mm"/></div>
			                        </div>
			                        <div class="detail-item">
			                            <div class="detail-label">수정일</div>
			                            <div class="detail-value"><fmt:formatDate value="${content.irModAt}" pattern="yyyy. MM. dd HH:mm"/></div>
			                        </div>
			                        <div class="detail-item">
