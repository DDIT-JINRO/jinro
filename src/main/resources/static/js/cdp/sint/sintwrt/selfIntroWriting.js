...
function autoCompleteHandler() {
	...
	const sampleAnswers = {
		'지금까지의 성장 과정 중 본인에게 가장 큰 영향을 준 경험을 구체적으로 기술하세요':
		...
		'본인의 가장 큰 강점과 약점을 각각 기술하고, 약점을 극복하기 위해 기울인 노력을 구체적으로 서술하세요':
		...
		'지원한 동기와 본인이 기여할 수 있는 부분을 서술하세요.':
		...
		'건설 현장에서의 안전을 위해 가장 중요하게 생각하는 요소는 무엇인가요?':
			`건설 현장의 안전을 위해 가장 중요한 요소는 **'사전 예방 문화'**라고 생각합니다. 이는 단순히 규정을 준수하는 것을 넘어, 모든 작업자가 잠재적 위험을 미리 인지하고 스스로 안전을 실천하는 문화를 의미합니다. 저는 이러한 문화를 조성하기 위해, AI 기반의 위험 예측 시스템을 도입하여 위험 요소를 실시간으로 분석하고 작업자에게 경고하는 시스템을 개발하고 싶습니다. 이를 통해 안전 수칙이 습관처럼 자리 잡는 현장을 만드는 데 기여하고 싶습니다.`,

		'본인이 경험한 프로젝트 중에서 가장 도전적이었던 사례를 소개해주세요.':
