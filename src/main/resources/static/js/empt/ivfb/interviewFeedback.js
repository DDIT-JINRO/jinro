...
document.addEventListener('DOMContentLoaded', function() {
	...
	const updateSelectedFiltersDisplay = () => {
		...
		if (checkedOrder) {
			...
			const tagHTML = `<span class="search-filter__tag" data-name="sortOrder" dta-value="${checkedOrder.value}">정렬 > ${labelText}<button type="button" class="search-filter__tag-remove">×</button></span>`;
			selectedFiltersContainer.insertAdjacentHTML('beforeend', tagHTML);
		}
